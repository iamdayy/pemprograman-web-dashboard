    ...
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href=" https://demos.creative-tim.com/argon-dashboard/pages/dashboard.html "
        ...
        <img src="assets/img/logo-ct-dark.png" width="26px" height="26px" class="navbar-brand-img h-100"
          alt="main_logo">
        <span class="ms-1 font-weight-bold">Iamdayy</span>
      </a>
    </div>
              ...
              <table class="table align-items-center mb-0">
                ...
                <tbody>
                  <?php foreach ($users as $user) : ?>
                    <tr data-nim="<?= $user['NIM'] ?>">
                      <td class="align-middle text-sm font-weight-bolder nama">
                        <?= $user['Nama'] ?>
                      </td>
                      <td class="align-middle text-sm jekel">
                        <?= $user['Jekel'] ?>
                      </td>
                      <td class="align-middle text-sm kelas">
                        <?= $user['Kelas'] ?>
                      </td>
                      <td class="align-middle text-sm angkatan">
                        <?= $user['Angkatan'] ?>
                      </td>
                      <td class="align-middle text-sm semester">
                        <?= $user['Semester'] ?>
                      </td>
                      <td class="align-middle text-sm">
                        <button type="button" class="btn bg-gradient-primary" id="editButton" data-bs-toggle="modal" data-bs-target="#editModal">
                          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil" viewBox="0 0 16 16">
                            <path d="M12.146.146a.5.5 0 0 1 .708 0l3 3a.5.5 0 0 1 0 .708l-10 10a.5.5 0 0 1-.168.11l-5 2a.5.5 0 0 1-.65-.65l2-5a.5.5 0 0 1 .11-.168zM11.207 2.5 13.5 4.793 14.793 3.5 12.5 1.207zm1.586 3L10.5 3.207 4 9.707V10h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.293zm-9.761 5.175-.106.106-1.528 3.821 3.821-1.528.106-.106A.5.5 0 0 1 5 12.5V12h-.5a.5.5 0 0 1-.5-.5V11h-.5a.5.5 0 0 1-.468-.325" />
                          </svg>
                        </button>
                        <button type="button" class="btn bg-danger" id="deleteButton" data-bs-toggle="modal" data-bs-target="#deleteModal">
  ...
  <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <form id="editForm" method="POST" action="../users/update.php">
          <div class="modal-body">
            ...
            <div class="row mb-3">
              ...
              <div class="col-md-6">
                <div class="form-group position-relative">
                  <label for="jekel" class="form-control-label">Jenis Kelamin</label>
                  <select class="form-control" id="jekel" placeholder="Jenis Kelamin" name="Jekel">
            ...
            <div class="row mb-3">
              <div class="col-md-6">
                <div class="form-group position-relative">
                  ...
                  <input type="number" class="form-control" id="angkatan" placeholder="Angkatan" name="Angkatan">
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group position-relative">
  ...
  <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel"
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <form id="deleteForm" method="POST" action="../users/delete.php">
          <div class="modal-body">
            <p>Are you sure you want to delete this user?</p>
            <input type="number" class="form-control" id="nimToDelete" placeholder="NIM" name="NIM">
          </div>
          <div class="modal-footer">
            <button type="button" class="btn bg-gradient-secondary" data-bs-dismiss="modal">Close</button>
    ...
    document.addEventListener('DOMContentLoaded', function() {
      ...
      editButtons.forEach(function(button) {
        button.addEventListener('click', function() {
          ...
          var angkatan = row.querySelector('.angkatan').textContent.trim();
          var semester = row.querySelector('.semester').textContent.trim();
          var nama = row.querySelector('.nama').textContent.trim();
          var jekel = row.querySelector('.jekel').textContent.trim();
          var kelas = row.querySelector('.kelas').textContent.trim();
          console.log(jekel)
          document.getElementById('nim').value = nim;
          document.getElementById('angkatan').value = Number(angkatan);
          document.getElementById('semester').value = Number(semester);
          document.getElementById('nama').value = nama;
          document.getElementById('jekel').value = jekel;
      ...
      deleteButtons.forEach(function(button) {
        button.addEventListener('click', function() {
          ...
          var nim = row.dataset.nim;
          console.log(nim)
          document.getElementById('nimToDelete').value = nim;
        });
      });
    });
  </script>
